  ...
  return (
    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 lg:gap-16">
      <div className="flex-1 max-w-2xl hero-fade-1">
        <h1 className={`text-5xl lg:text-7xl font-black text-white uppercase leading-[1.05] tracking-tight transition-all duration-500 ${isTransitioning ? "opacity-0 translate-y-6" : "opacity-100 translate-y-0"}`}>
          {slide.heading}
        </h1>
      </div>
