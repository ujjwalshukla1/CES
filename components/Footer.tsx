...
const fallbackData: FooterData = {
  ...
  copyrightText: "Copyright CSE. Design By GramenTheme",
};
  ...
  return (
    <footer className="relative bg-gray-950 text-gray-300 overflow-hidden">
        ...
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            >
              ...
              {/* Flask */}
              <path
                d="M110 10 L110 28 L100 48 Q99 51 102 51 L118 51 Q121 51 120 48 L110 28"
                fill="none"
                stroke="white"
                strokeWidth="0.8"
              />
              ...
              {/* Hexagon */}
              <polygon
                points="170,25 180,20 190,25 190,35 180,40 170,35"
                fill="none"
                stroke="white"
                strokeWidth="0.8"
              />
              <polygon
                points="173,27 178,24 183,27 183,33 178,36 173,33"
                fill="none"
                stroke="white"
                strokeWidth="0.5"
              />
              {/* DNA */}
              <path
                d="M15 70 Q27 78 15 86 Q3 94 15 102"
                fill="none"
                stroke="white"
                strokeWidth="0.8"
              />
              <path
                d="M27 70 Q15 78 27 86 Q39 94 27 102"
                fill="none"
                stroke="white"
                strokeWidth="0.8"
              />
              ...
              />
              <path
                d="M140 95 Q140 102 144 102 Q148 102 148 95"
                fill="none"
                stroke="white"
                strokeWidth="0.8"
              />
              ...
              />
              <polyline
                points="125,138 128,141 133,136"
                fill="none"
                stroke="white"
                strokeWidth="0.8"
                strokeLinecap="round"
              ...
              />
              <polyline
                points="125,146 128,149 133,144"
                fill="none"
                stroke="white"
                strokeWidth="0.8"
                strokeLinecap="round"
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <svg
          className="absolute w-14 h-14 text-white/10 animate-float-1"
          style={{ top: "8%", left: "5%" }}
          viewBox="0 0 60 80"
          fill="none"
          stroke="currentColor"
        ...
        <svg
          className="absolute w-12 h-12 text-white/10 animate-float-2"
        ...
        <svg
          className="absolute w-8 h-16 text-white/10 animate-float-3"
        ...
        <svg
          className="absolute w-10 h-10 text-white/10 animate-float-4"
        ...
        <svg
          className="absolute w-10 h-10 text-white/10 animate-float-5"
        ...
        <svg
          className="absolute w-12 h-12 text-white/10 animate-float-6"
        ...
        <svg
          className="absolute w-10 h-14 text-white/10 animate-float-7"
        ...
        <svg
          className="absolute w-12 h-14 text-white/10 animate-float-8"
          style={{ top: "5%", left: "88%" }}
          viewBox="0 0 45 55"
          fill="none"
          stroke="currentColor"
        ...
        <svg
          className="absolute w-6 h-14 text-white/10 animate-float-9"
        ...
        <svg
          className="absolute w-10 h-10 text-white/8 animate-float-10"
        ...
        <svg
          className="absolute w-10 h-10 text-white/8 animate-float-11"
        ...
        <svg
          className="absolute w-12 h-12 text-white/8 animate-float-12"
          style={{ top: "30%", left: "92%" }}
          viewBox="0 0 60 80"
          fill="none"
          stroke="currentColor"
          strokeWidth="1.5"
